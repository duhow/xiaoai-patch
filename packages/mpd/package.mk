...
configure_package() {
	...
	PKG_CONFIG_LIBDIR="${BUILD_PKG_CONFIG_LIBDIR}" PKG_CONFIG_SYSROOT_DIR="${BUILD_PKG_CONFIG_SYSROOT_DIR}" meson \
										--cross-file cross-file.build ${PACKAGE_SRC_DIR} output/release \
										--buildtype=debugoptimized -Db_ndebug=true --prefix=${INSTALL_PREFIX}
}
