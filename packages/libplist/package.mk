...
PACKAGE_SRC="https://github.com/libimobiledevice/libplist/archive/${PACKAGE_VERSION}.tar.gz"
PACKAGE_DEPENDS="glib libxml gcc"

configure_package() {
	./autogen.sh CC="${BUILD_CC}" CFLAGS="${BUILD_CFLAGS}" LDFLAGS="${BUILD_LDFLAGS} -lm" \
